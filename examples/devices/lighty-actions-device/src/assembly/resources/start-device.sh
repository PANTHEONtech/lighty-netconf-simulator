...
CLASSPATH=lighty-action-device-17.3.0-SNAPSHOT.jar
...
#echo $CLASSPATH
java -server -Xms16M -Xmx40M -XX:MaxMetaspaceSize=40m -classpath $CLASSPATH io.lighty.netconf.device.action.Main $1
